...
const projects: Project[] = [
    ...
    relatedProjects: [
      {
        ...
        title: "웹경리나라 서비스",
        category: "SaaS 서비스",
        image: "/webcash-accounting-banner.png",
      },
      {
        slug: "rethorike-ai-writing",
        title: "AI 작문 서비스",
        category: "AI 서비스",
        image: "/rhetorike-landing-page.jpeg",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    description: [
      "LLM 기반 작문 서비스를 만드는 에듀테크 스타트업의 첫 번째 프로젝트인 GLOT 입니다. 레토리케의 GLOT은 체계적이고, 논리적이고, 구조적인 사고력 향상을 목표로 하고 있습니다. 사용자가 작문하며 다음에 이어갈 문장의 유형을 선택하며 문장을 이어나가는 점에서 AI를 활용하지만 사용자가 주도해나가는 점이 특징입니다.",
      "랜딩페이지부터 서비스 기획, 제로베이스에서 정책 수립 및 기준을 수립한 경험이었습니다.",
    ],
    features: [
      "랜딩페이지 기획, 출시",
      "PRD 작성 및 전체 와이어프레임 구성",
      "구독모델을 기반으로 한 PG사 연동 결제/환불 프로세스",
      "결제 및 환불 및 각종 정책, 이용약관 정의",
      "백오피스 어드민 기능 (가입자, 요금제, FAQ 관리)",
    ],
    technologies: ["Figma", "Slack", "Notion", "Jira", "Google Docs", "Google Forms", "AI/LLM"],
    coverImage: "/rhetorike-landing-page.jpeg",
    thumbnailImage: "/rhetorike-landing-page.jpeg",
    gallery: [
      {
